...
Which version of Python is currently the preferred version?
A) Python 2.0
B) Python 3.0
...
What are some key areas in which Python excels?
...
<!-- How can you access the Terminal in Windows?
...
<!-- Which command is used to create a new file in the Terminal?
A) `pwd`
B) `ls`
C) `cd`
D) `touch`
...
B) An interactive computing environment for creating and sharing documents.
...
A) Markdown, code execution, and data visualization.
...
Which statement correctly assigns a value to a variable in Python?
A) x + 5 = 10
B) 10 = x + 5
C) x = 10 + 5
D) x = 10 = 5
...
What does it mean for variables in Python to have dynamic nature?
...
What is data type conversion in Python called?
A) Dynamic typing
...
Which operator is used for arithmetic addition in Python?
A) +
B) -
C) *
D) /
...
In Python, what happens when you concatenate a number with a string?
...
Which logical operator in Python represents logical AND?
A) and
B) or
C) not
D) xor
...
What is the result of the expression age >= 18 if age is 21?
A) True
B) False
C) None
D) An error occurs.
...
What does the term "Boolean" refer to in Python?
...
Which operator is used for logical NOT in Python?
A) and
B) or
C) not
D) xor
...
What is the purpose of the format() method and f-strings in Python?
...
What is the purpose of escape characters in Python?
...
How can you access individual elements in a list using their index?
...
What is the purpose of the in and not in operators when used with lists?
A) To concatenate two lists.
B) To check if a specific element exists or does not exist in a list.
...
What does the in operator do when used with dictionaries in Python?
...
D) It reverses the order of keys in the dictionary.
ANSWER: A

Which method is used to retrieve all keys of a dictionary in Python?
A) keys()
B) values()
C) items()
D) get()
...
Which method is used to retrieve all values of a dictionary in Python?
A) keys()
B) values()
C) items()
D) get()
...
Which method is used to retrieve both keys and their corresponding values in a dictionary?
A) keys()
B) values()
C) items()
D) get()
...
How are integers and floats distinguished in Python?
...
What are the keywords used for conditional statements in Python?
A) "if", "else", "elif"
B) "for", "while", "do"
...
In Python, which keyword is used to execute a block of code when a condition is True?
A) "while"
B) "if"
C) "for"
D) "do"
...
What is the purpose of nesting conditional statements in Python?
A) To create loops.
...
Which type of loop in Python repeats a block of code as long as a specified condition is True
A) "while" loop
B) "for" loop
C) "do-while" loop
D) "if-else" loop
...
How can you prematurely exit a loop in Python?
...
Which type of loop is used when the number of iterations is known in advance or when iterating over elements of a sequence?
A) for loop
B) while loop
C) do-while loop
D) if-else loop
...
When is a while loop used in Python?
...
How do you call or execute a function in Python?
...
How can you import specific functions or objects from a module?
...
Which type of error occurs when the code violates Python's language rules?
A) Syntax Error
B) Name Error
C) Type Error
D) Value Error
...
What type of error occurs when an undefined variable or function is used?
A) Syntax Error
B) Name Error
C) Type Error
D) Value Error
...
What type of error occurs when an operation is performed on an inappropriate type of value?
A) Syntax Error
B) Name Error
C) Type Error
D) Value Error
ANSWER: C
What type of error occurs when an invalid value is supplied to a function?
...
What type of error occurs when division by zero is attempted?
A) Syntax Error
B) Name Error
C) Type Error
...
What is the purpose of the try-except construct in Python?
A) To prevent errors from occurring in the code.
...
What is the purpose of the finally block in the try-except construct?
A) To prevent errors from occurring in the code.
B) To handle and manage errors during program execution.
C) To execute specific code only if no errors occur.
D) To execute specific code irrespective of whether an error occurs or not.
...
How can you handle multiple exceptions in a single except block in Python?
